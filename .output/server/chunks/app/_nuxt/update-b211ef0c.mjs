import { defineComponent, withCtx, createTextVNode, unref, createVNode, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const lab_id = parseInt(route.params.id, 10);
      ...
      _push(ssrRenderComponent(VCard, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$1, { lab_id: unref(lab_id) }, null, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
              ...
              createVNode("div", { class: "mt-4" }, [
                createVNode(_sfc_main$1, { lab_id: unref(lab_id) }, null, 8, ["lab_id"])
              ])
            ];
          }
        }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/dashboard/labs/[id]/update.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=update-b211ef0c.mjs.map
