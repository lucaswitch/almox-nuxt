import { createVNode, Transition, mergeProps, reactive, computed, toRef, watch, ref, Fragment, Teleport, withDirectives, vShow, resolveDirective, inject, shallowRef, provide, watchEffect, nextTick, effectScope, onScopeDispose, toRaw, readonly, warn } from 'vue';
import { f as forwardRefs, a as animate, d as deceleratedEasing, s as standardEasing, b as acceleratedEasing, n as nullifyTransforms, B as Box, g as getOverflow } from './forwardRefs-80fc40bb.mjs';
import { a as makeDimensionProps, C as useBackgroundColor, h as useDimension, F as useRouter, q as VDefaultsProvider, G as parseAnchor, H as flipSide, I as flipAlign, J as flipCorner, K as getAxis } from './VBtn-3a93cc12.mjs';
import { g as genericComponent, p as propsFactory, m as makeThemeProps, a as useProxiedModel, h as provideTheme, H as useRtl, y as useToggleScope, d as convertToUnit, s as omit, l as getUid, F as refElement, x as getCurrentInstance, G as IN_BROWSER, J as focusableChildren, L as getNextElement, K as focusChild, A as isOn, B as eventName, C as destructComputed, q as matchesSelector, D as consoleError, e as clamp } from '../server.mjs';
import { m as makeComponentProps, u as useRender } from './tag-a1f3d414.mjs';
import { u as useScopeId } from './scopeId-e7d4fba3.mjs';
import { m as makeTransitionProps, M as MaybeTransition } from './VImg-b87ba832.mjs';
...
export { VDialogTransition as V, VMenu as a, VOverlay as b, makeVOverlayProps as m };
//# sourceMappingURL=VMenu-9a09071e.mjs.map
