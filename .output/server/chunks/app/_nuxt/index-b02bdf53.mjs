...
import { p as propsFactory, m as makeThemeProps, g as genericComponent, h as provideTheme, H as useRtl, o as provideDefaults, I as IconValue, _ as _export_sfc, d as convertToUnit } from '../server.mjs';
import { t as makeBorderProps, a as makeDimensionProps, b as makeElevationProps, c as makeLocationProps, d as makePositionProps, e as makeRoundedProps, C as useBackgroundColor, y as useBorder, h as useDimension, i as useElevation, j as useLocation, k as usePosition, l as useRounded, m as makeDensityProps, g as useDensity, x as makeSizeProps, z as useSize, p as VIcon, q as VDefaultsProvider, V as VBtn } from './VBtn-3a93cc12.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(VTimeline, { align: "start" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(VTimelineItem, { "dot-color": "primary" }, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<div${_scopeId2}><div class="text-h6"${_scopeId2}>Login</div><p${_scopeId2}> Done! </p></div>`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(VTimelineItem, { "dot-color": "primary" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<div class="text-h6"${_scopeId2}>Materiais</div><p${_scopeId2}> Ainda \xE9 necess\xE1rio retificar os campos de acordo com a necessidade do cliente. </p>`);
            } else {
              return [
                createVNode("div", { class: "text-h6" }, "Materiais"),
                createVNode("p", null, " Ainda \xE9 necess\xE1rio retificar os campos de acordo com a necessidade do cliente. ")
              ];
            }
          }),
          _: 1
        ...
        _push2(ssrRenderComponent(VTimelineItem, { "dot-color": "primary" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<div class="text-h6"${_scopeId2}>Cadastro de laborat\xF3rios</div><p${_scopeId2}> Done! </p>`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(VTimelineItem, { "dot-color": "primary" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<div class="text-h6"${_scopeId2}>Devolu\xE7\xE3o de materiais de reserva</div><p${_scopeId2}> Done! </p>`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(VTimelineItem, { "dot-color": "gray" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<div class="text-h6"${_scopeId2}>Relat\xF3rio mensal</div><p${_scopeId2}> Ainda n\xE3o conclu\xEDdo </p>`);
            } else {
              return [
                createVNode("div", { class: "text-h6" }, "Relat\xF3rio mensal"),
                createVNode("p", null, " Ainda n\xE3o conclu\xEDdo ")
              ];
            }
          }),
          _: 1
        ...
        return [
          createVNode(VTimelineItem, { "dot-color": "primary" }, {
            opposite: withCtx(() => [
              createTextVNode(" Roadmap de constru\xE7\xE3o ")
            ]),
            default: withCtx(() => [
          ...
          createVNode(VTimelineItem, { "dot-color": "gray" }, {
            default: withCtx(() => [
              createVNode("div", { class: "text-h6" }, "Relat\xF3rio mensal"),
              createVNode("p", null, " Ainda n\xE3o conclu\xEDdo ")
            ]),
...
//# sourceMappingURL=index-b02bdf53.mjs.map
